...
public class Tab4Adapter extends RecyclerView.Adapter<Tab4Adapter.Tab4ViewHolder>{
    ...
    public Tab4Adapter(ArrayList<String> strings,Context context)
    {
    ...
    public Tab4ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemview = LayoutInflater.from(parent.getContext()).inflate(R.layout.tab4frag, null);
        Tab4ViewHolder viewHolder = new  Tab4ViewHolder(itemview);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final Tab4ViewHolder holder, int position) {
...
//                    animation(holder.mDownload);
    ...
    static class Tab4ViewHolder extends RecyclerView.ViewHolder {
        ...
        public Tab4ViewHolder(View itemView) {
            ...
            mClickableLayout=(LinearLayout)itemView.findViewById(R.id.tab4clickable_LinearLayout);
            divider=(View)itemView.findViewById(R.id.divider_tab4);
            mDownload=(ImageView)itemView.findViewById(R.id.tab4Fragdownload1);
            mDownLoad2=(ImageView)itemView.findViewById(R.id.tab4Fragdownload2);
    ...
    class ViewDialog {
        public void showDownLoadDialog(Context activity, String msg, final  Tab4ViewHolder holder) {
        ...
        public void showDeleteDialog(Context activity, String msg, final  Tab4ViewHolder holder) {
            final Dialog dialog = new Dialog(activity);
            dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
            dialog.setCancelable(false);
            dialog.setContentView(R.layout.custom_dialog);
