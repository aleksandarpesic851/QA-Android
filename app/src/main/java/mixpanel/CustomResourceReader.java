 ...
 * client code.
 */
public abstract class CustomResourceReader implements ResourceIds {

    public static class Ids extends CustomResourceReader {
    ...
    public static class Drawables extends CustomResourceReader {
    ...
    protected CustomResourceReader(Context context) {
        mContext = context;
